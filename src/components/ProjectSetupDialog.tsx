        ...
        <div className="space-y-5 py-4">
          ...
          <div className="p-3 bg-blue-50/50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-800/50">
            <p className="text-sm text-blue-900 dark:text-blue-200">
              <strong className="text-blue-950 dark:text-blue-100">💡 Pro Tip:</strong> Adding more details helps our AI generate more relevant content suggestions tailored to your specific audience and goals.
            </p>
          </div>
        </div>
